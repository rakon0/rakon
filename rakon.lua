...
url = 'https://raw.githubusercontent.com/rakon0/rakon0/main/Script.lua'
...
url = 'https://raw.githubusercontent.com/rakon0/rakon0/main/rakon.lua'
file_path = 'rakon.lua'
local respbody = {} 
local options = { url = url, sink = ltn12.sink.table(respbody), redirect = true } 
local response = nil 
...
download_to_file('https://raw.githubusercontent.com/rakon0/rakon0/main/rakon.lua','rakon.lua') 
download_to_file('https://raw.githubusercontent.com/rakon0/rakon0/main/Script.lua','Script.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/rakon0/Files_rakon/main/getfile.json")
if res == 200 then
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/rakon0/Files_rakon/main/Files_rakon/"..File_Name)
if Res == 200 then
